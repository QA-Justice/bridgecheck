...
export const DEFAULT_PREVIEW_FIELD_WIDTH = 280
export const MIN_PREVIEW_FIELD_WIDTH = 220
export const MAX_PREVIEW_FIELD_WIDTH = 900
...
export function clampPreviewFieldWidth(width: number): number {
  return Math.min(MAX_PREVIEW_FIELD_WIDTH, Math.max(MIN_PREVIEW_FIELD_WIDTH, width))
}
